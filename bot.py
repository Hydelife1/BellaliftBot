...
# --- CONFIG ---
TELEGRAM_TOKEN = "8417631668:AAHOWeiFFMWmnNxviiE1cjx69Oupi1GvGUA"
IMAGE_API_URL = "https://api.example-image.service/generate"  # placeholder
IMAGE_API_KEY = "YOUR_IMAGE_API_KEY"
VOICE_PROVIDER = "gtts"  # o 'elevenlabs' etc.
...
def get_or_create_profile(chat_id):
    ...
    if str(chat_id) not in profiles:
        profiles[str(chat_id)] = {
            ...
            "attitude": "pícara",
            "seed": 123456,  # semilla para generación coherente
            "last_prompt": ""
        }
...
def generate_image(prompt, seed=None):
    # Ajusta esta función al API que uses (Stable Diffusion web, Replicate, OpenAI, etc.)
    # Ejemplo genérico POST JSON -> returns image bytes
    ...
    r.raise_for_status()
    # suponemos que la API devuelve bytes de imagen
...
async def audio_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # añade rasgos a la forma de hablar
...
# Simple callback for inline buttons
